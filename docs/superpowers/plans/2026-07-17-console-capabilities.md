...
Run: `mvn -q -pl cm-agent-server -am -Dtest='!ConsoleSmokeTest,!*JdbcPersistenceTest' -Dsurefire.failIfNoSpecifiedTests=false test`

Expected: BUILD SUCCESS；不执行需要 Testcontainers 的测试类。
